...
The Dream, Style Transfer, Super Resolution or Inpainting modes are available in a Jupyter Notebook [here](https://huggingface.co/DeepFloyd/IF-I-XL-v1.0/blob/main/notebooks/pipes-DeepFloyd-IF-v1.0.ipynb).
...
For super-resolution, users can run `IF-II` and `IF-III` or 'Stable x4' on an image that was not necessarily generated by IF (two cascades):
...
- Thanks, [@patrickvonplaten](https://github.com/patrickvonplaten), for improving the loading time of unet models by 80%;
